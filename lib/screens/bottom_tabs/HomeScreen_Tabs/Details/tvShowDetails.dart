...
import 'package:ott/screens/bottom_tabs/HomeScreen_Tabs/Details/Watch/watchTvShow.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "Episodes for Season ${seasonindex + 1}",
                                      style: TextStyle(
                                        fontSize: 18,
                                  ...
                                  child: SingleChildScrollView(
                                    child: Padding(
                                      ...
                                      child: Wrap(
                                        ...
                                        children: List.generate(
                                          episodeCount,
                                          (episodeIndex) => GestureDetector(
                                            onTap: () {
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                      builder: (context) => WatchTvShow(
                                                          showId: widget.Id,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            show.seasons != null && show.seasons!.length > 2
